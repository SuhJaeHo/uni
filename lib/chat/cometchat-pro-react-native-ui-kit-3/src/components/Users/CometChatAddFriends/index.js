...
import CometChatSearchUserListItem from '../CometChatSearchUserListItem';
...
class CometChatAddFriends extends React.PureComponent {
  ...
  //검색 창에서 닉네임 입력하면 해당 유저 리스트에 보여지게끔
  searchUsers = () => {      
    this.setState({
...
export default CometChatAddFriends;
